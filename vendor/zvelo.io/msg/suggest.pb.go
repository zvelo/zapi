...
func encodeFixed64Suggest(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32Suggest(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
...
var fileDescriptorSuggest = []byte{
	...
	0xa6, 0xea, 0xb9, 0x24, 0x96, 0x24, 0x06, 0xa7, 0x96, 0x04, 0xc1, 0x94, 0x38, 0xd9, 0x5d, 0x78,
	...
	0x18, 0xa2, 0x78, 0x20, 0xa6, 0x65, 0x82, 0xdd, 0x96, 0xc4, 0x06, 0x76, 0x94, 0x31, 0x20, 0x00,
	0x00, 0xff, 0xff, 0x66, 0x5e, 0xbf, 0xa8, 0xd3, 0x00, 0x00, 0x00,
}
